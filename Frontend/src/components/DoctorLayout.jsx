            ...
            <nav className="bg-[#0d3b36] sticky top-0 z-10">
                <div className="max-w-6xl mx-auto px-6 py-3 flex justify-between items-center flex-wrap gap-3">
                    ...
                    <div className="flex items-center gap-1">
                        <Link
                            to="/doctor-dashboard"
                            className={`px-3.5 py-2 rounded-full text-sm font-medium transition ${isActive("/doctor-dashboard")
                        ...
                        <Link
                            to="/appointments"
                            className={`px-3.5 py-2 rounded-full text-sm font-medium transition ${isActive("/appointments")
                                ? "bg-white text-[#0d3b36]"
                                : "text-white/70 hover:bg-white/10 hover:text-white"
                                }`}
                        >
