...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            login(res.data.user, res.data.data);
            ...
            <div className="hidden lg:flex lg:col-span-2 flex-col justify-between bg-[#0d3b36] px-10 py-10 text-white">
                ...
                <div>
                    ...
                    <h2 className="mt-2 text-2xl font-extrabold leading-tight">
                        Every prescription, appointment and record in one calm place.
                    </h2>
                    <p className="mt-3 text-sm text-white/70">
                        MediTrack keeps patients and doctors on the same page.
                    </p>
                </div>
                ...
                <p className="flex items-center gap-1.5 text-xs text-white/60">
                    ...
                    Your care information is treated with respect and privacy.
                </p>
            </div>
                ...
                <div className="w-full max-w-sm">
                    ...
                    <form onSubmit={handleSubmit} className="mt-6 rounded-2xl border border-[#e4dfd2] bg-white p-6 shadow-sm">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-xs font-semibold text-[#0d3b36] cursor-pointer">
                                Forgot password?
                            </span>
                        </div>
                    ...
                    <p className="mt-5 text-center text-sm text-[#6b6558]">
                        New to MediTrack?{" "}
                        <Link to="/register" className="font-semibold text-[#0d3b36]">
                            Create account
                        </Link>
                    </p>
